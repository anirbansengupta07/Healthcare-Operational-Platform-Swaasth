...
struct MentalHealthSurveyView: View {
    ...
    let model = GenerativeModel(name: "gemini-2.0-flash-lite", apiKey: DocAI2.default)
    ...
    private func generateMentalHealthResponse() {
        ...
        Task {
            do {
                ...
                let prompt = "Based on the patient's survey responses: \(mentalHealthCondition). Please provide recommendations for improving their mental health."
